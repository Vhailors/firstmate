...
test_pi_snippet_uses_effective_extension_path() {
  local home out launcher turnend watch
  ...
  assert_contains "$out" "launched through \`$launcher\`" "pi snippet did not render the scoped primary launcher"
  ...
  assert_not_contains "$out" "__FM_PI_LAUNCHER__" "renderer leaked the Pi launcher placeholder"
