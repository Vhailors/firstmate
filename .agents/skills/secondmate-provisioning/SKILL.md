...
Keep persistent secondmates pinned as `pi openai-codex/gpt-5.6-luna high`; future launches and safe respawns re-read that primary-home pin without rewriting active homes or current task metadata.
