...
Firstmate sets `FM_PI_HARNESS` explicitly for both worker launch identities, and `bin/fm-pi-primary.sh` establishes the same boundary for a primary session.
