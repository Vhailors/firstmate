...
For remote provisioning, including the `--herdr-session` pin and supplied project origins, follow [Remote second mates](remote-secondmates.md#provision-a-route).
